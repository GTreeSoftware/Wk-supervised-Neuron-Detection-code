"""
This is the main training function of VoxResNet model for neurite prediction
It can be used for both supervised or weakly-supervised learning of the network training,
(only annotation difference between supervised or weakly-supervised learning)
Usage:
