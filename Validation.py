"""
This function is used to get the validation result of the network model
input:
    opt: the parameter setting object from config file
    val_loader: data loader of the validation dataset
    model: network model
    criterion: loss function
    vis_tool: the visualization tool to inspect the validation process
output:
    avg_loss: average loss value
    val_dice.avg: average dice metric value
    val_recall.avg: average recall metric value
"""
